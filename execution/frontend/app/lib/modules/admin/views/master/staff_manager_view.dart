...
class StaffManagerView extends GetView<MasterController> {
  ...
  void _showEditForm(BuildContext context, Map<String, dynamic> profile) {
    ...
    final specCtrl = TextEditingController(
      text:
          ((profile['specialties'] as List?)?.cast<String>().join(', ') ?? ''),
    );
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                _Field(controller: bioCtrl, label: 'Bio', maxLines: 3),
                const SizedBox(height: ESpacing.md),
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              Get.back();
              await controller.updateStaffProfile(profile['id'] as String, {
