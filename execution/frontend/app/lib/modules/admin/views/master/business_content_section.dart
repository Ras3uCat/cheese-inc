...
class BusinessContentSection extends StatefulWidget {
  ...
  @override
  State<BusinessContentSection> createState() => _BusinessContentSectionState();
}
...
class _BusinessContentSectionState extends State<BusinessContentSection> {
  ...
  void initState() {
    ...
    _heroImage = TextEditingController(
      text: c['hero_image_url'] as String? ?? '',
    );
    _heroOverline = TextEditingController(
      text: c['hero_overline'] as String? ?? '',
    );
    _heroTagline = TextEditingController(
      text: c['hero_tagline'] as String? ?? '',
    );
    _servicesOverline = TextEditingController(
      text: c['services_overline'] as String? ?? 'What We Offer',
    );
    _servicesTitle = TextEditingController(
      text: c['services_title'] as String? ?? 'Our Services',
    );
    _servicesSubtitle = TextEditingController(
      text: c['services_subtitle'] as String? ?? '',
    );
    _ctaTitle = TextEditingController(
      text: c['cta_title'] as String? ?? 'Ready to Get Started?',
    );
    _ctaButton = TextEditingController(
      text: c['cta_button_label'] as String? ?? 'Book Your Appointment',
    );
  }
